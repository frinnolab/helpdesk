...
<div class="admin">
    <div class="hello card">
        <h3 class="hlltxt0" >Company Name</h3>
        <h3 class="hlltxt0">Address</h3>
        <h3 class="hlltxt0">Contact</h3>
        <h3 class="hlltxt0">Contact/ Person</h3>
        <h3 class="hlltxt0">Contact/ Person Email</h3>
